...
export async function restoreFromTrash(key: string): Promise<TrashItem | undefined> {
  const tables = [db.trash, db.tasks, db.notes, db.projects, db.people, db.habits, db.subscriptions, db.goals, db.interactions, db.habitLogs, db.routines, db.routineRuns, db.things]
